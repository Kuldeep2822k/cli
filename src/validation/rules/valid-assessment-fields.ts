 ...
 * `assessed_at` must be null or a real calendar date (impossible dates
 * like `2026-02-30` are rejected, not silently normalized). Shape only —
 * mastery formula consistency belongs to `valid-topic-mastery` (#37).
 */
