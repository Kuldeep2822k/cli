...
| Transactional Fixes | Planned | Implementation of `validate --fix` to resolve broken dependencies or missing fields — modeled via `fixable` rule metadata, deferred per [ADR-0008](https://github.com/Kuldeep2822k/cli/blob/main/docs/adr/0008-validation-framework-decisions.md) | `validate.ts` |
